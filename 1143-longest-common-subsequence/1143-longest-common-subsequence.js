...
// if current chars from two strings are the same, dp[i][j] = dp[i-1][j-1]+1, 等于both string without current chars subseq length, e.g 'fabc', 'hadc', c is in both strings, so common subseq for the two strings 'fabc' and 'hadc' equals common subseq for 'fab' and 'had' + 1
